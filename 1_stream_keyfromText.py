...
myfile = open("result.txt","w", encoding='UTF8')
read_file = open("keyword.txt","r", encoding='UTF8')

# read_file = open("C:\\Users\\KH.PIYANUSH\\Downloads\\keyword.txt", "r")
for line in read_file:
    new_tweets = api.search(q=line, count=tweetsPerQry, lang='th')
    for tweet in new_tweets:
        # print(tweet.id_str)
        myfile.writelines(json.dumps(tweet._json,ensure_ascii=False))
# read_file.close()
# read_file = open(“keyword.txt”,”r”)


# new_tweets = api.search(q='Fantastic Beasts', count=tweetsPerQry, lang='th')
#
# for tweet in new_tweets:
#     # print(tweet)
#     print(tweet.id_str)
